<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_simpleboot3/admin/dress_up/chat_bubble.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;"><?php echo lang('ADMIN_CHAT_BUBBLE_LIST'); ?></a></li>
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <!--<td class="gift-img"><img src="<?php echo $vo['v_bg']; ?>" alt=""></td>-->
