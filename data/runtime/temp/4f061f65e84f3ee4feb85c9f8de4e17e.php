<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"themes/admin_simpleboot3/admin/dress_up/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;"><?php echo lang('ADMIN_MEAL_LIST'); ?></a></li>
        <li><a href="<?php echo url('dress_up/noble_index'); ?>"><?php echo lang('ADMIN_NOBLE'); ?> <?php echo lang('ADMIN_MEAL_LIST'); ?></a></li>
        <li><a href="<?php echo url('Dress_up/add'); ?>"><?php echo lang('ADMIN_MEAL_ADD'); ?></a></li>
    </ul>
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('dress_up/add',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a> |
