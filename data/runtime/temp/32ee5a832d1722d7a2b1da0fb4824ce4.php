<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin/rbac/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
			...
			<table class="table table-hover table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<?php if($vo['id'] == 1): ?>
								<font color="#cccccc"><?php echo lang('ROLE_SETTING'); ?></font>  <!-- <a href="javascript:openIframeDialog('<?php echo url('rbac/member',array('id'=>$vo['id'])); ?>','成员管理');"><?php echo lang('成员管理'); ?></a> | -->
							...
							<?php else: ?>
								...
								<!-- <a href="javascript:openIframeDialog('<?php echo url('rbac/member',array('id'=>$vo['id'])); ?>','成员管理');"><?php echo lang('成员管理'); ?></a>| -->
