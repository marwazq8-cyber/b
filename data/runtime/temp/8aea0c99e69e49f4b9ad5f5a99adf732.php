<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"themes/admin_simpleboot3/admin/dress_up/chat_bg_add.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a  href="<?php echo url('dress_up/chat_bg'); ?>"><?php echo lang('ADMIN_CHAT_BG_LIST'); ?></a></li>
        <li><a href="<?php echo url('Dress_up/noble_chat_bg'); ?>"><?php echo lang('ADMIN_NOBLE'); ?> <?php echo lang('ADMIN_CHAT_BG_LIST'); ?></a></li>
        <li class="active"><a href="javascript:;"><?php echo lang('ADMIN_ADD_CHAT_BG'); ?></a></li>
    </ul>
        ...
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <!--<tr>
                        <th><?php echo lang('图标'); ?><span class="form-required">75*98</span></th>
                        <td>
                    ...
                    <tr>
                        <th><?php echo lang('ADMIN_CHAT_BG'); ?><span class="form-required">833*1246</span></th>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="post[img_bg]" id="thumbnailbg" value="<?php echo (isset($data['img_bg'] ) && ($data['img_bg']  !== '')?$data['img_bg'] :''); ?>">
                                <a href="javascript:uploadOneImage('<?php echo lang("图片上传"); ?>','#thumbnailbg');">
                                ...
                                <input type="button" class="btn btn-sm btn-cancel-thumbnailbg" value="<?php echo lang('取消图片'); ?>">
                            </div>
                        </td>
                    </tr>

                    <!--<tr>
                        <th><?php echo lang('展示背景图'); ?><span class="form-required">*</span></th>
                        <td>
                            <div style="text-align: center;">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('dress_up/chat_bg'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
