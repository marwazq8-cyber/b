<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/admin/slide_item/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('SlideItem/index',['slide_id'=>$slide_id]); ?>"><?php echo lang('幻灯片页面列表'); ?></a></li>
        <?php if($slide_id != 3): ?>
            ...
            <?php if(is_array($result) || $result instanceof \think\Collection || $result instanceof \think\Paginator): if( count($result)==0 ) : echo "" ;else: foreach($result as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        ...
                        <?php if($slide_id != 3): ?>
                            <a href="<?php echo url('SlideItem/delete',array('id'=>$vo['id'])); ?>" class="js-ajax-delete"><?php echo lang('DELETE'); ?></a>
                        <?php endif; if(empty($vo['status']) == 1): ?>
                            <a href="<?php echo url('SlideItem/cancelban',array('id'=>$vo['id'])); ?>" class="js-ajax-dialog-btn"
                               data-msg="<?php echo lang('确定显示此幻灯片吗？'); ?>"><?php echo lang('DISPLAY'); ?></a>
                            <?php else: ?>
                            <a href="<?php echo url('SlideItem/ban',array('id'=>$vo['id'])); ?>" class="js-ajax-dialog-btn"
                               data-msg="<?php echo lang('确定隐藏此幻灯片吗？'); ?>"><?php echo lang('HIDE'); ?></a>
                        <?php endif; ?>
                    </td>
                </tr>
