<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/user/webuploader.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap " style="padding:5px;">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#wrapper" data-toggle="tab"><?php echo lang("上传文件"); ?></a></li>
        <li class=""><a href="#B" data-toggle="tab"><?php echo lang("网络文件"); ?></a></li>
        <!--<li class=""><a href="#explorer" data-toggle="tab"><?php echo lang("文件管理"); ?></a></li>-->
    </ul>
    <div class="tabbable">
                    ...
                    <div id="uploader">
                        <div class="queueList">
                            <div id="dndArea" class="placeholder">
                                ...
                                <p><?php echo lang("或将文件拖到这里，单次最多可选个文件",['max_files'=> $max_files]); ?></p>
                            </div>
                        </div>
                        <div class="statusBar" style="display:none;">
                            ...
                            <div class="btns">
                                ...
                                <div class="uploadBtn"><?php echo lang("开始上传"); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="tab-pane" id="B"> <?php echo lang('请输入网络地址'); ?>
                <div class="bk3"></div>
    ...
    (function ($) {
        ...
        $(function () {
            ...
            function addFile(file) {
                var $li       = $('<li id="' + file.id + '">' +
                    ...
                    $btns     = $('<div class="file-panel">' +
                        '<span class="cancel"><?php echo lang('DELETE'); ?></span>' +
                        '<span class="rotateRight"><?php echo lang("向右旋转"); ?></span>' +
                        '<span class="rotateLeft"><?php echo lang("向左旋转"); ?></span></div>').appendTo($li),
                    ...
                    showError = function (code) {
                        switch (code) {
                            case 'exceed_size':
                                text ="<?php echo lang('文件大小超出'); ?>";
                                break;

                            case 'interrupt':
                                text ="<?php echo lang('上传暂停'); ?>";
                                break;

                            default:
                                text ="<?php echo lang('上传失败，请重试'); ?>";
                                break;
                        }
            ...
            function updateStatus() {
                ...
                if (state === 'ready') {
                    text ="<?php echo lang('选中'); ?>" + fileCount +"<?php echo lang('个文件，共'); ?>" +
                        WebUploader.formatSize(fileSize) + '。';
                } else if (state === 'confirm') {

                    stats = uploader.getStats();
                    if (stats.uploadFailNum) {
                        text ="<?php echo lang('已成功上传'); ?>" + stats.successNum +"<?php echo lang('个文件，'); ?>" +
                            stats.uploadFailNum +"<?php echo lang('个文件上传失败'); ?>，<a class=\"retry\" href=\"#\"><?php echo lang("重新上传"); ?></a><?php echo lang("失败文件或"); ?><a class=\"ignore\" href=\"#\"><?php echo lang("忽略"); ?></a>"
                    }

                } else {
                    stats = uploader.getStats();

                    text ="<?php echo lang('共'); ?>" + fileCount +"<?php echo lang('个文件（'); ?>" +
                        WebUploader.formatSize(fileSize) +
                        '），已上传' + stats.successNum +"<?php echo lang('个'); ?>";

                    if (stats.uploadFailNum) {
                        text += '，失败' + stats.uploadFailNum +"<?php echo lang('个'); ?>";
                    }
            ...
            uploader.onError = function (code) {
                switch (code) {
                    ...
                    case "Q_EXCEED_NUM_LIMIT":
                        code = "最多只能上传" + maxFiles +"<?php echo lang('个文件'); ?>";
                        break;
                    case "F_DUPLICATE":
                        code = "文件重复添加！";
                        break;
