<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"themes/admin_simpleboot3/user/admin_asset/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('AdminAsset/index'); ?>"><?php echo lang("资源列表"); ?></a></li>
    </ul>
    <?php $status=['不可用',"<?php echo lang('可用'); ?>"]; ?>
    <table class="table table-hover table-bordered margin-top-20">
        <thead>
        <tr>
            <th width="50">ID</th>
            <th><?php echo lang('USER'); ?></th>
            <th><?php echo lang("文件大小"); ?></th>
            <th><?php echo lang("文件名"); ?></th>
            <th><?php echo lang("图像"); ?></th>
            <th><?php echo lang("文件路径"); ?></th>
        ...
        <?php 
         ...
         if(is_array($assets) || $assets instanceof \think\Collection || $assets instanceof \think\Paginator): if( count($assets)==0 ) : echo "" ;else: foreach($assets as $key=>$vo): ?>
            <tr>
                ...
                <td>
                    <?php echo lang('USER_ID'); ?>:<?php echo $vo['user_id']; ?> <?php echo $vo['user_login']; ?> <?php echo $vo['user_nickname']; ?>
                </td>
