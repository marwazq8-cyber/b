<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"themes/admin_simpleboot3/admin/refill/pay_menu.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="javascript:;"><?php echo lang('充值渠道列表'); ?></a></li>
        <li><a href="<?php echo url('refill/add_pay_menu'); ?>"><?php echo lang('添加支付渠道'); ?></a></li>
    </ul>
    ...
    <table  class="js-ajax-form table table-hover table-bordered table-list">
        ...
        <tr>
            ...
            <th><?php echo lang('商户号'); ?></th>
            <th>APP_ID</th>
            <th><?php echo lang('类名'); ?></th>
            <th><?php echo lang('ADMIN_RECHARGE_TOTAL'); ?></th>
<!--            <th>ios是否显示</th>-->
...
<!--                <?php if($vo['ios_on'] == 0): ?>
                ...
                <?php endif; ?>
                <td>
                    <a href="<?php echo url('refill/edit_pay_menu',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a> |
...
<script>
    $(".del").click(function(){
        ...
        layer.confirm("<?php echo lang('DELETE_CONFIRM_MESSAGE'); ?>", {
            ...
            $.ajax({
                url: "<?php echo url('refill/del_pay_menu'); ?>",
                type: 'post',
                dataType: 'json',
                data: {id: id},
