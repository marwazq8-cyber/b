<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin/noble/add_log.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li ><a href="<?php echo url('noble/add_noble_log'); ?>"><?php echo lang('ADMIN_OPEN_LIST'); ?></a></li>
        <li class="active"><a href="javascript:;"><?php echo lang('ADMIN_OPEN_MANUAL'); ?></a></li>

    </ul>
    <form action="<?php echo url('noble/add_log_post'); ?>" method="post">
        <div class="row gift">
            <div class="col-md-8  col-md-offset-2">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[uid]"
                                   id="title" required value="<?php echo (isset($data['uid'] ) && ($data['uid']  !== '')?$data['uid'] :''); ?>" placeholder="<?php echo lang('USER_ID'); ?>"/>
                        </td>
                    </tr>


                    <tr>
                        <th><?php echo lang('ADMIN_NOBLE'); ?><span class="form-required">*</span></th>
                        <td>
                            <select name="post[nid]" id="gift">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('noble/add_noble_log'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
