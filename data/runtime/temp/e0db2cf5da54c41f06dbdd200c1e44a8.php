<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin/user/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
        ...
        <form class="well form-inline margin-top-20" method="post" action="<?php echo url('User/index'); ?>">
            ...
            <input type="text" class="form-control" name="user_login" style="width: 120px;" value="<?php echo input('request.user_login/s',''); ?>" placeholder="<?php echo lang('请输入用户昵称'); ?>">
			<?php echo lang('EMAIL'); ?>:
            <input type="text" class="form-control" name="user_email" style="width: 120px;" value="<?php echo input('request.user_email/s',''); ?>" placeholder="<?php echo lang('请输入email'); ?>">
            <input type="submit" class="btn btn-primary" value="<?php echo lang('SEARCH'); ?>" />
            <a class="btn btn-danger" href="<?php echo url('User/index'); ?>"><?php echo lang('EMPTY'); ?></a>
        </form>
		<table class="table table-hover table-bordered">
			<thead>
				<tr>
					...
					<th width="200"><?php echo lang('ACTIONS'); ?></th>
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<font color="#cccccc"><?php echo lang('EDIT'); ?></font>  <font color="#cccccc"><?php echo lang('DELETE'); ?></font>
							...
							<?php endif; endif; ?>
						<a href='<?php echo url("user/login_log",array("uid"=>$vo["id"])); ?>'><?php echo lang('记录'); ?></a>
					</td>
				</tr>
