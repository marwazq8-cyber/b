<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"themes/admin_simpleboot3/admin/storage/index.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<!--        <li><a href="<?php echo url('plugin/setting',array('id'=>1)); ?>"><?php echo lang('七牛配置'); ?></a></li>-->
        <li><a href="<?php echo url('upload/setting',array('type'=>1)); ?>"><?php echo lang('腾讯云COS配置'); ?></a></li>
    </ul>
    <form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('storage/settingPost'); ?>">

        <div class="form-group">
            <label for="input-type" class="col-sm-2 control-label"><?php echo lang('存储类型'); ?></label>
