<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin_simpleboot3/admin/slide/edit.html";i:1730282264;s:94:"/www/wwwroot/admin.xivolive.com/TomChat-PHP/public/themes/admin_simpleboot3/public/header.html";i:1730282264;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo url('slide/index'); ?>"><?php echo lang('幻灯片列表'); ?></a></li>
			<li class="active"><a><?php echo lang('编辑幻灯片'); ?></a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('slide/editPost'); ?>">
			<div class="form-group">
				<label for="input-name" class="col-sm-2 control-label"><?php echo lang('ADMIN_NAME'); ?><span class="form-required">*</span></label>
