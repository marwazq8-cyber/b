...
class StripeWebApi extends Base
{
    /**
     * 展示支付页面
     */
    public function pay_index()
    {
        ...
        $pay_config = db('pay_menu')->where("class_name ='StripeWeb_pay' and status = 1")->find();
        if (!$pay_config) {
        ...
        $this->assign('publishable_key', 'pk_live_51QmjC6BoBX6YEQvIO4t37sqRF63YB7ZnyfMWOm6lyPJ3V7w7rTuVwo7KteQN1rzFFcsZ2c8vF7zXM8fgdCoK8loL00yTOU62um');
        return $this->fetch();
