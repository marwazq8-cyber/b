...
class ArticleController extends HomeBaseController
{
    public function index()
    {
        ...
        if (empty($articleId) || empty($article)) {
            abort(404, lang('model data Not Found'));
        }
     //   var_dump($article);exit;
        ...
        if (empty($categoryId)) {
            ...
            if (count($categories) > 0) {
                ...
                abort(404, lang('Article_does_not_specify_classification'));
            }
    ...
    public function doLike()
    {
        ...
        if ($canLike) {
            ...
            $this->success(lang('Great'));
        } else {
            $this->error(lang('You_already_liked_it'));
        }
    }
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $this->success(lang('ADD_SUCCESS'), url('Article/myIndex', ['id' => $portalPostModel->id]));
        }
    }
