...
class AdminCategoryController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        $result = $this->validate($data, 'PortalCategoryValidate');
        ...
        $this->success(lang('ADD_SUCCESS'), url('AdminCategory/index'));
