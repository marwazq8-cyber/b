...
class AdminArticleController extends AdminBaseController
{
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $post   = $data['post'];
            $result = $this->validate($post, 'AdminArticleValidate');
            if ($result !== true) {
                $this->error($result);
            }
            ...
            $this->success(lang('ADD_SUCCESS'), url('AdminArticle/edit', ['id' => $portalPostModel->id]));
        }
    ...
    public function publish()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $this->success(lang('Published_successfully'), '');
        }
        ...
        if (isset($param['ids']) && isset($param["no"])) {
            ...
            $this->success(lang('Unpublish_succeeded'), '');
        }
    ...
    public function top()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $this->success(lang('Successful_topping'), '');
        ...
        if (isset($_POST['ids']) && isset($param["no"])) {
            ...
            $this->success(lang('Successfully_cancel_topping'), '');
        }
    }
    ...
    public function recommend()
    {
        ...
        if (isset($param['ids']) && isset($param["yes"])) {
            ...
            $this->success(lang('Recommended_successfully'), '');
        ...
        if (isset($param['ids']) && isset($param["no"])) {
            ...
            $this->success(lang('Recommendation_cancelled_successfully'), '');
