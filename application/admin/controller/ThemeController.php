...
class ThemeController extends AdminBaseController
{
    ...
    public function uninstall()
    {
        ...
        if ($theme == "simpleboot3" || config('cmf_default_theme') == $theme ){
            $this->error(lang("官方自带模板或当前使用中的模板不可以卸载"));
        }
        ...
        $this->success(lang('Uninstall_succeeded'), url("theme/index"));
    ...
    public function installTheme()
    {
        ...
        $this->success(lang('Installation_succeeded'), url("theme/index"));
    }
    ...
    public function update()
    {
        ...
        $this->success(lang('Update_succeeded'), url("theme/index"));
    }
