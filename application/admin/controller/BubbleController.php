...
class BubbleController extends AdminBaseController
{
    /**
     * 泡泡列表
     */
    public function index()
    {
        ...
        if (input('request.type') || input('request.gift_id') || input('request.continuous_id')) {
    ...
    public function addPost()
    {
        ...
        if ($result) {
            ...
            redis_hSet("user_bubble_list",$data['type']."_".$data['continuous_id']."_".$data['pool_id'],json_encode(array()));
            redis_hSet("user_bubble_list_spare",$data['type']."_".$data['continuous_id']."_".$data['pool_id'],json_encode(array()));
            $user_pool = db('bubble_user_pool')->where('continuous_id = '.$data['continuous_id'].' and pool_id = '.$data['pool_id'])->select();
            ...
            $this->success(lang('EDIT_SUCCESS'), url('bubble/index'));
        } else {
    ...
    public function del()
    {
        ...
        if ($result) {
            $where=  "i.type=". $bubble_one['type']." and i.continuous_id=".$bubble_one['continuous_id'];
    ...
    public function eggs_log(){
        ...
        $list = Db::name('playing_bubble_log')->alias("e")
    ...
    public function add_post_magic_wand(){
        ...
        if ($result) {
            $this->success(lang('EDIT_SUCCESS'), url('bubble/magic_wand'));
        } else {
            $this->error(lang('EDIT_FAILED'));
        }
    }
    ...
    public function poolAddPost()
    {
        ...
        if ($result) {
            ...
            $this->success(lang('EDIT_SUCCESS'), url('Bubble/pool_index'));
        } else {
            $this->error(lang('EDIT_FAILED'));
        }
    }
    ...
    public function user_pool(){
        ...
        $list = db('bubble_user_pool')
            ...
            ->join('bubble_type t','t.id=b.continuous_id')
            ->where($where)
