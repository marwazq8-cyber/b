...
class SettingController extends AdminBaseController
{
    ...
    public function sitePost()
    {
        if ($this->request->isPost()) {
            $result = $this->validate($this->request->param(), 'SettingSiteValidate');
            if ($result !== true) {
                $this->error($result);
            }
    ...
    public function passwordPost()
    {
        if ($this->request->isPost()) {
            ...
            if (empty($data['old_password'])) {
                $this->error(lang('Original_password_cannot_empty'));
            }
            ...
            if (cmf_compare_password($oldPassword, $admin['user_pass'])) {
                if ($password == $rePassword) {
                    ...
                    if (cmf_compare_password($password, $admin['user_pass'])) {
                        $this->error(lang('password_is_same_as_original_password'));
                    } else {
