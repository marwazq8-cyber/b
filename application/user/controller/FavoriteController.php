...
class FavoriteController extends UserBaseController
{
    ...
    public function delete()
    {
        ...
        if ($data) {
            $this->success(lang('Cancel_collection_successfully'));
        } else {
            $this->error(lang('Failed_to_cancel_collection'));
        }
    }
    ...
    public function add()
    {
        ...
        if ($findFavoriteCount > 0) {
            $this->error(lang('You_have_collected_it'));
        }
        ...
        $this->success(lang('Collection_succeeded'));
