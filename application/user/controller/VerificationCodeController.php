...
class VerificationCodeController extends HomeBaseController
{
    public function send()
    {
        ...
        $validate->message([
            'username.require' => lang('Enter_mobile_number_email_address'),
        ]);
        ...
        if (Validate::is($data['username'], 'email')) {
            ...
            $this->error(lang('Enter_correct_mobile_phone_email_format'));
        }
        ...
        if (empty($code)) {
            $this->error(lang('Too_many_verification_codes_sent'));
        }
        ...
        if ($accountType == 'email') {
            ...
            if (empty($result['error'])) {
                ...
                $this->success(lang('Verification_code_sent_successfully'));
            } else {
                $this->error(lang('Email_verification_code_sending_failed') . $result['message']);
            }
            ...
            if ($result === false) {
                $this->error(lang('Verification_code_sending_plug_in_not_installed'));
            }
