...
class ExportSQL extends Command
{
    ...
    {
        // 这里描述这个任务做什么的
        $this->setName('bogokj:ExportTable')->setDescription('山东布谷鸟网络科技[导出纯净数据库结构与数据]');
    }
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        $db = [
            ...
            'hostname' => 'localhost',
            // 数据库名
            'database' => 'demo-voicechat',
            // 数据库用户名
            'username' => 'demo-voicechat',
            // 数据库密码
            'password' => 'ZEK2RAbCnADTekGH',
            // 数据库连接端口
            'hostport' => '',
            // 数据库连接参数
            'params' => [],
...
EOT;
        ...
        // 获取数据库中所有的表名
        $allTables = $connect->query('SHOW TABLES');
